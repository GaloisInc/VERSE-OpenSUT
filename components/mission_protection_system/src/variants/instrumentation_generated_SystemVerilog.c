#ifdef PLATFORM_HOST
#include "verilator_build/generated/SystemVerilog/generate_sensor_trips/VGenerate_Sensor_Trips.h"
#include "verilator_build/generated/SystemVerilog/is_ch_tripped/VIs_Ch_Tripped.h"
#include <stdio.h>
#else
#include "printf.h"
#endif
